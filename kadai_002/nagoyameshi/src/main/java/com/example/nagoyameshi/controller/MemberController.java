...
public class MemberController {
	...
	public MemberController(MemberRepository memberRepository, AuthenticationRepository authenticationRepository, MemberService memberService) {
	...
	public String index(@AuthenticationPrincipal UserDetailsImpl userDetailsImpl, Model model) {
		Member membr = memberRepository.getReferenceById(userDetailsImpl.getMember().getId());
		Authentication authentication = authenticationRepository.getReferenceById(userDetailsImpl.getMember().getId());

		model.addAttribute("member", membr);
	...
	public String edit(@AuthenticationPrincipal UserDetailsImpl userDetailsImpl, Model model) {
		...
		MemberEditForm memberEditForm = new MemberEditForm(member.getId(), member.getName(), member.getFurigana(), member.getPostalCode(), member.getAddress(), member.getPhoneNumber(), authentication.getEmail());
